...
return [
    ...
    'notification_new_operation'      => '<!channel> :rocket: Опубликован новый вылет !',
    'notification_edit_operation'     => '<!channel> :pencil2: Вылет был отредактирован !',
    'notification_cancel_operation'   => '<!channel> :no_entry_sign: Вылет был отменен !',
    'notification_activate_operation' => '<!channel> :white_check_mark: Отмененный вылет был активирован снова !',
